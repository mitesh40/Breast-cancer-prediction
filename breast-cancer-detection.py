#attempt by MITESH KUMAR
#get helped from my teacher Jai chitkara sir in cetpa
...
tk.Label(root,text='Clump Thickness ',padx=40, font=("times new roman", 12)).grid(row=1,column=0)
cthick = tk.IntVar()
